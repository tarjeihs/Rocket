...
void FVkSampler::Initialize(FVkSamplerCreateInfo& CreateInfo)
{
    ...
    SamplerCreateInfo.addressModeV                      = VK_SAMPLER_ADDRESS_MODE_REPEAT;           // V axis (vertical)
    SamplerCreateInfo.addressModeW                      = VK_SAMPLER_ADDRESS_MODE_REPEAT;           // W axis (depth or third dimension for cubemaps)}
