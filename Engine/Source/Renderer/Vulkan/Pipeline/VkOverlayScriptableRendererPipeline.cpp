...
#include "VkOverlayScriptableRendererPipeline.h"
...
void FVkOverlayScriptableRendererPipeline::Initialize(FVkPipelineLayout* PipelineLayout)
{
...
void FVkOverlayScriptableRendererPipeline::Shutdown()
{
    //ImGui_ImplVulkan_Shutdown();
}

void FVkOverlayScriptableRendererPipeline::Execute()
{
