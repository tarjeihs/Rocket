...
//
   ...
   // ColorAttachment.imageView = GetRHI()->GetRenderer()->GetColorAttachment16()->GetVkImageView();
...
//
   ...
   // DepthAttachment.imageView = GetRHI()->GetRenderer()->GetDepthAttachmentD32()->GetVkImageView();
...
//
   ...
   // RenderingInfo.renderArea = VkRect2D { VkOffset2D { 0, 0 }, VkExtent2D { GetRHI()->GetRenderer()->GetColorAttachment16()->GetImageExtent2D().width, GetRHI()->GetRenderer()->GetColorAttachment16()->GetImageExtent2D().height }};
...
//
   ...
   // Viewport.x = 0;
   // Viewport.y = 0;
   // Viewport.width = GetRHI()->GetRenderer()->GetColorAttachment16()->GetImageExtent2D().width;
   // Viewport.height = GetRHI()->GetRenderer()->GetColorAttachment16()->GetImageExtent2D().height;
...
//
   ...
   // Scissor.offset.x = 0;
   // Scissor.offset.y = 0;
   // Scissor.extent.width = GetRHI()->GetRenderer()->GetColorAttachment16()->GetImageExtent2D().width;
   // Scissor.extent.height = GetRHI()->GetRenderer()->GetColorAttachment16()->GetImageExtent2D().height;
